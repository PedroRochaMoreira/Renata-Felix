...
| `RF_SEED_CATALOG`                                 | Defina como`true` apenas para exibir a vitrine de demonstração enquanto a loja ainda não tem peças cadastradas. Em produção deixe vazio: as peças de demonstração não são vendáveis. |
