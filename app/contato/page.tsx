...
const mapsUrl =
  'https://www.google.com/maps/search/?api=1&query=Renata+Felix+Store%2C+Rua+Jose+Alencar%2C+Qd+77%2C+Lt+12%2C+Luziania%2C+GO%2C+72804-030';
      ...
      <main id="conteudo" tabIndex={-1} className="contactPage contactExperience">
        <section className="contactHero" aria-labelledby="contact-title">
          <div className="contactHeroCopy">
            ...
            <h1 id="contact-title" className="serif">
              Fale conosco,
              <br />
              <em>com calma.</em>
            </h1>
            <p>
              Queremos que cada escolha seja leve — antes, durante e depois da sua compra. Nossa equipe está por perto para orientar você.
            </p>
          ...
          <aside className="contactHeroPanel" aria-label="Canais rápidos de atendimento">
            ...
            <a className="contactHeroAction" href="tel:+5561994230194">
              ...
              <span>
                <b>(61) 99423-0194</b>
                <small>Ligue para a nossa equipe</small>
              </span>
              <ArrowUpRight size={17} aria-hidden="true" />
            </a>
        ...
        <section className="contactConversation" aria-labelledby="contact-form-title">
          <div className="contactConversationIntro">
            ...
            <h2 id="contact-form-title" className="serif">
              Como podemos ajudar você?
            </h2>
            <p>
              Conte-nos o que precisa. Para assuntos sobre pedidos, inclua o número do pedido na mensagem para conseguirmos localizar tudo
              com mais agilidade.
            </p>
            ...
            <div className="contactQuestions">
              ...
              <details open>
                ...
                <p>
                  Envie a mensagem com o número do pedido ou consulte as orientações de <Link href="/trocas">trocas e devoluções</Link>.
                </p>
              </details>
              <details>
                <summary>Onde fica a loja física?</summary>
                <p>
                  Estamos na R. José Alencar, Qd. 77 · Lt. 12, em Luziânia — GO. <Link href="/lojas">Veja o endereço e o mapa</Link>.
                </p>
              </details>
              <details>
          ...
          <form className="contactForm contactFormRefined" onSubmit={submit}>
            ...
            <div className="contactFormGrid">
              ...
              <label className="contactFormWide">
                Mensagem
                <textarea name="message" required aria-required="true" rows={7} placeholder="Conte-nos como podemos ajudar você." />
              </label>
            </div>
            <div className="contactFormFooter">
              <button className="button dark" type="submit" disabled={isSubmitting}>
                {isSubmitting ? (
                  ...
                  <>
                    Enviar mensagem <Send size={15} aria-hidden="true" />
                  </>
                )}
              </button>
              {status && (
                <p className={`contactFormStatus ${status.tone}`} role="status" aria-live="polite">
                  {status.text}
                </p>
              )}
            </div>
        ...
        <section className="contactVisit" aria-labelledby="contact-visit-title">
          <div>
            ...
            <h2 id="contact-visit-title" className="serif">
              Uma conversa também pode ser ao vivo.
            </h2>
          </div>
          <div className="contactVisitDetails">
            ...
            <p>
              ...
              <br />
              Luziânia — GO · CEP 72804-030
            </p>
            <a className="textLink" href={mapsUrl} target="_blank" rel="noreferrer">
              Abrir no Google Maps <ArrowUpRight size={13} aria-hidden="true" />
            </a>
          </div>
        </section>
      </main>
