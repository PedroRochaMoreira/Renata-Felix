...
export default function EditarProduto() {
  ...
  useEffect(() => {
    Promise.all([fetch('/api/auth/me').then(r => r.json()), fetch('/api/catalog').then(r => r.json()), fetch('/api/admin/gallery').then(r => r.json())])
