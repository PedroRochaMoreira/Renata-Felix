...
export function Footer() {
  return <footer className="footer">
    <div className="footerTop">
      ...
      <div><h4>Fale conosco</h4><p>Seg. a sex. · 9h às 18h</p><a href="mailto:contato@renatafelix.com.br">contato@renatafelix.com.br</a><a href="tel:+5511999999999">+55 11 99999-9999</a></div>
    </div>
    <div className="footerBottom"><span>© 2026 Renata Felix. Todos os direitos reservados.</span><span>São Paulo · Brasil</span></div>
  </footer>;
}
