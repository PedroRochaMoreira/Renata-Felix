    ...
    <>
      ...
      <main className="catalog">
        <div className="catalogTitle">
          ...
          <p>Peças salvas para você revisitar quando quiser.</p>
        </div>
        {!hydrated ? (
          <p className="info">Carregando seus favoritos...</p>
        ) : items.length ? (
          <div className="grid">
            {items.map(product => (
          ...
          <div className="empty favoritesEmpty">
            <p>Você ainda não salvou peças.</p>
            <Link className="button dark" href="/loja">
              Explorar a loja
            </Link>
          </div>
        )}
