...
export default function Carrinho() {
  const { cart, remove, setQuantity, shipping, setShipping, hydrated } = useStore();
  ...
  const changeQuantity = (id: string, size: string, quantity: number, stock: number) => { setQuantity(id, size, quantity, stock); setShipping(null); };
